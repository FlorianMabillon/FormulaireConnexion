...
&& !empty($_POST['password_confirm'])){
    ...
    if($password != $password_confirm){
        header('location: ../FormulaireConnexion/index.php/?error=1&pass=1');
    }
    ...
    while($email_verification = $req->fetch()){
        if($email_verification['numberEmail'] != 0){
            header('location: ../FormulaireConnexion/index.php/?error=1&email=1');
        }
    }
    ...
    header('location: ../FormulaireConnexion/index.php/?succes=1');
}
...
<body>
    ...
    if(!isset($_SESSION['connect'])){ ?>
        ...
        echo'<p id="succes=>Inscription prise correctement en compte</p>';
    }
        ?>
        ...
        <div id="form">
            <form method="post" action="index.php">
                <table>
                    <tr>
                        <td>Pseudo</td>
                        <td><input type="text" name="pseudo" placeholder="Ex: George" required></td>
                    </tr>
                    <tr>
                        <td>Email</td>
                    ...
                    <tr>
                        ...
                        <td><input type="password" name="password_confirm" id="" placeholder="*****" required></td>
                    </tr>
                    </table>
                    <div id="button">
